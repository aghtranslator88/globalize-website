...
async function main() {
  ...
  const settings = [
    ...
    { key: 'address_ar', value: '1 شارع جامعة القاهرة، مكتب 29، الدور الثامن، أعلى عمر أفندي، الجيزة' },
    { key: 'address_en', value: '1 Cairo University St., Office 29, 8th Floor, Above Omar Effendi, Giza, Egypt' },
