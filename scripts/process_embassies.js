...
function generateEmbassyArticle(itemSlug, parsedData, index) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `يمكنك إرسال صور أولية واضحة للمستندات عبر الواتساب على الرقم 01062990808 أو زيارة أحد فروعنا للبدء الفوري.`
    }
  ];
